...
export const SubmitButton = ({ label }: { label: string }) => {
  ...
  return (
    <button type="submit" className={className} disabled={pending}>
      {label === "save" ? (
        // kalo tombol save di tekan, akan menampilkan "Saving..." dan tidak bisa diitekan selama proses pending berjalan
        <span>{pending ? "Saving..." : "Save"}</span>
      ) : (
        // kalo tombol update di tekan, akan menampilkan "Updating..." dan tidak bisa diitekan selama proses pending berjalan
